...
$ucssp=get-content -path C:\blade.txt
#$ucssp="mwvhes0015","mwvhes0016","mwvhes0018","mwvhes0389","mwvhes0390"

foreach ($usp in $ucssp)
{$usphba=get-ucsserviceprofile -name $usp |get-ucsvhba
write-host $usp
foreach ($hba in $usphba)
{write-host $hba.addr}}
